...
> this is a fork of [repo](https://github.com/aarifhusaincom/mongodb-sample-databases).

> the original repo has BSON dump. I've removed it and I added a bash [script](https://github.com/aarifhusaincom/mongodb-sample-dataset/blob/main/script.sh) to import the JSON to respective db 
